...
| Recovery rate (record count) | 42.9% | 55.6% | 50.0% | 52.4% |
| Records paid | 54 / 126 | 70 / 126 | 63 / 126 | 66 / 126 |
...
| Contacts per Rs recovered | 0.00000000 | 0.00002910 | 0.00001126 | 0.00001075 |
| False interventions | 0 | 104 | 23 | 23 |
| - on disputed invoices | 0 | 76 | 8 | 8 |
| - on already-paid / unreconciled invoices | 0 | 28 | 15 | 15 |
| Policy vetoes | n/a (bypassed) | n/a (bypassed) | 247 | 231 |
| - regulatory-source vetoes | n/a (bypassed) | n/a (bypassed) | 0 | 8 |
| - merchant-policy vetoes | n/a (bypassed) | n/a (bypassed) | 247 | 223 |
| Policy modifications | n/a (bypassed) | n/a (bypassed) | 16 | 16 |
| Deferred vetoes | n/a (bypassed) | n/a (bypassed) | 247 | 231 |
| STOP decisions | 0 | 36 | 0 | 0 |
| Escalated to human (agent-selected) | 0 | 0 | 16 | 16 |
...
- Agent write-offs are zero because the 28-day horizon ends mid-ladder: it made 0 STOP decisions after 231 deferred vetoes. This is horizon truncation, not evidence of restraint.
