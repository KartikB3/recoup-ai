...
|---|---|---|---|---|
| Recovery rate (value) | 49.3% | 62.3% | 56.5% | 56.7% |
| Recovery rate (record count) | 42.9% | 55.6% | 50.0% | 50.8% |
| Records paid | 54 / 126 | 70 / 126 | 63 / 126 | 64 / 126 |
...
| Contacts per Rs recovered | 0.00000000 | 0.00002910 | 0.00001126 | 0.00000955 |
| False interventions | 0 | 104 | 23 | 23 |
| - on disputed invoices | 0 | 76 | 8 | 8 |
| - on already-paid / unreconciled invoices | 0 | 28 | 15 | 15 |
| Policy vetoes | n/a (bypassed) | n/a (bypassed) | 247 | 272 |
| - regulatory-source vetoes | n/a (bypassed) | n/a (bypassed) | 0 | 6 |
| - merchant-policy vetoes | n/a (bypassed) | n/a (bypassed) | 247 | 266 |
| Policy modifications | n/a (bypassed) | n/a (bypassed) | 16 | 17 |
| Deferred vetoes | n/a (bypassed) | n/a (bypassed) | 247 | 219 |
| STOP decisions | 0 | 36 | 0 | 0 |
| Escalated to human (agent-selected) | 0 | 0 | 16 | 17 |
| Human queue from payer response | 0 | 28 | 2 | 5 |
...
| `batch-cluster-suppression` | Active when an aggregate suppression is approved; the first group contact opens one consolidated escalation and later ones are suppressed. | bypassed | bypassed | 0 | 54 |
...
| `payer-contact-frequency` | Active merchant frequency cap. | bypassed | bypassed | 65 | 48 |
...
- Agent write-offs are zero because the 28-day horizon ends mid-ladder: it made 0 STOP decisions after 219 deferred vetoes. This is horizon truncation, not evidence of restraint.
